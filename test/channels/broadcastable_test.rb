...
class TurboClone::BroadcastableTest < ActionCable::Channel::TestCase
  ...
  test "#broadcast_append_to" do
    ...
    assert_broadcast_on "stream", turbo_stream_action_tag(:append, target: 'articles', template: ApplicationController.render(article)) do
  ...
  test "#broadcast_prepend_to" do
    ...
    assert_broadcast_on "stream", turbo_stream_action_tag(:prepend, target: 'board_articles', template: ApplicationController.render(article)) do
  ...
  test "#broadcast_replace_to" do
    ...
    assert_broadcast_on "stream", turbo_stream_action_tag(:replace, target: article, template: ApplicationController.render(article)) do
